...
app.get('/login', renderLoginPage.renderLoginPage);                  // IGNORE // - displays the login page with form for username and password; a link to create account is also visible.
...
// PUT
// app.put('/createAccount', saveUser.saveUser);                              // TODO // - sends login data to be saved to database 'project' in table 'users'. 
